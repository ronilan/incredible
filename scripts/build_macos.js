...
const appName = metadataMatch ? metadataMatch[1] : 'Incredible App';
...
try {
    ...
    fs.copyFileSync(
        ...
        path.join('dist', 'incredible_macos')
    );

    console.log('Build successful! Binary copied to dist/incredible_macos');
} catch (error) {
